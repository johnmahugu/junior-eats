...
import { VictoryChart, VictoryLine, VictoryAxis, VictoryBrushContainer, VictoryZoomContainer } from 'victory'
    ...
    render() {
        ...
        return (
            <div style={styling.placeholder}>
                ...
                <VictoryChart
                    padding={{ top: 0, left: widthInt/8, right: widthInt/8, bottom: widthInt/12 }}
                    width={widthInt} height={heightInt / 4} scale={{ x: "time" }}
                    containerComponent={
