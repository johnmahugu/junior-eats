...
import { IMMultimediaComponent } from '../../../common'
import "./styles.css";
    ...
    if (singleMultimediaURL) {
        return (
            <div className="multimediaCellContainer">
                <IMMultimediaComponent openable className="multimediaCell" src={singleMultimediaURL} />
            </div>
        )
    }

    const mediaItems = multimediaURLs.map((data) =>
        <IMMultimediaComponent className="multiMultimediaCell" key={data.url} src={data.url} type={data.mime} openable />
    );
    return (
        <div className="multimediaCellContainer">
            {mediaItems}
