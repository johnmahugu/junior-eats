...
const UpdateReviewsView = (props) => {
    ...
    const saveChanges = async (modifiedData, setSubmitting) => {
        ...
        const response = await fetch(baseAPIURL + 'review/' + reviewId, {
    ...
    return (
        <Card className="Card FormCard">
            <CardBody>
            <h1>{originalData && originalData.starCount}</h1>
            <Formik
  ...
  export default UpdateReviewsView;