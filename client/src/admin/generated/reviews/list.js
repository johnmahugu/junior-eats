...
function ActionsItemView(props) {
    ...
    const handleView = (item) => {
        const viewPath = "/admin/review/" + item.id + '/view'
        history.push(viewPath)
    }

    const handleEdit = (item) => {
        const editPath = "/admin/review/" + item.id + '/update'
        history.push(editPath)
    }

    const handleDelete = async (item) => {
        if (window.confirm('Are you sure you want to delete this item?')) {
            const response = await fetch(baseAPIURL + 'review/' + item.id, {
...
function ReviewsListView(props) {
    const listName = "reviews"
    ...
    useEffect(() => {
        ...
        setReviews(data.slice(startRow, endRow))
                    ...
                    <Col md="12">
                        <div className="Card">
                            <div className="CardHeader">
                                <a className="Link AddLink" href="/admin/review/add">Add New</a>
                                <h4>Reviews</h4>
                            </div>
                                ...
                                <div className="TableContainer">
                                    <table className="Table" {...getTableProps()}>
                                        ...
                                        <tbody {...getTableBodyProps()}>
                                            ...
                                            <tr>
                                                {isLoading ? (
                                                    <td colSpan={reviewsColumns.length - 1}>
                                                        <p>
                                                            Loading...
                                                        </p>
                                                    </td>
