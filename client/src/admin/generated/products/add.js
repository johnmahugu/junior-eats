...
import IMProductsRestaurantTypeaheadComponent from '../ui/IMProductsRestaurantTypeaheadComponent.js'
...
const AddNewProductsView = () => {
    ...
    const createProducts = async (data, setSubmitting) => {
        console.log(JSON.stringify(data));
        setIsLoading(true);
        const response = await fetch(baseAPIURL + 'product/add', {
    ...
    return (
        ...
        if (!values.description) {
            errors.description = 'Field Required!'
                ...
                onSubmit={(values, { setSubmitting }) => {
                    createProducts(values, setSubmitting);
                }}
            >
                {({
                values,
        ...
        <div className="FormFieldContainer">
            ...
            <IMProductsRestaurantTypeaheadComponent onSelect={(value) => onTypeaheadSelect(value, "vendorID")} id={originalData && originalData.vendorID} name={originalData && originalData.vendorID} />
        </div>
