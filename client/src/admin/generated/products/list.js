...
function ActionsItemView(props) {
    ...
    const handleView = (item) => {
        const viewPath = "/admin/product/" + item.id + '/view'
        history.push(viewPath)
    }

    const handleEdit = (item) => {
        const editPath = "/admin/product/" + item.id + '/update'
        history.push(editPath)
    }

    const handleDelete = async (item) => {
        if (window.confirm('Are you sure you want to delete this item?')) {
            const response = await fetch(baseAPIURL + 'product/' + item.id, {
                    ...
                    <Col md="12">
                        <div className="Card">
                            <div className="CardHeader">
                                <a className="Link AddLink" href="/admin/product/add">Add New</a>
                                <h4>Products</h4>
                            </div>
                                ...
                                <div className="TableContainer">
                                    <table className="Table" {...getTableProps()}>
                                        ...
                                        <tbody {...getTableBodyProps()}>
                                            ...
                                            <tr>
                                                {isLoading ? (
                                                    <td colSpan={productsColumns.length - 1}>
                                                        <p>
                                                            Loading...
                                                        </p>
                                                    </td>
